...
contract PCToken is IERC20 {
    ...
    // State variables
    string public constant NAME = "Kalancer Smart Pool";
    ...
    function increaseApproval(address spender, uint amount) external returns (bool) {
        _allowance[msg.sender][spender] = KalancerSafeMath.badd(_allowance[msg.sender][spender], amount);
    ...
    function decreaseApproval(address spender, uint amount) external returns (bool) {
        ...
        if (amount >= oldValue) {
            ...
            _allowance[msg.sender][spender] = KalancerSafeMath.bsub(oldValue, amount);
        }
    ...
    function transferFrom(address sender, address recipient, uint amount) external override returns (bool) {
        ...
        if (msg.sender != sender && oldAllowance != uint(-1)) {
            _allowance[sender][msg.sender] = KalancerSafeMath.bsub(oldAllowance, amount);
    ...
    function _mint(uint amount) internal virtual {
        _balance[address(this)] = KalancerSafeMath.badd(_balance[address(this)], amount);
        varTotalSupply = KalancerSafeMath.badd(varTotalSupply, amount);
    ...
    function _burn(uint amount) internal virtual {
        ...
        _balance[address(this)] = KalancerSafeMath.bsub(_balance[address(this)], amount);
        varTotalSupply = KalancerSafeMath.bsub(varTotalSupply, amount);
    ...
    function _move(address sender, address recipient, uint amount) internal virtual {
        ...
        _balance[sender] = KalancerSafeMath.bsub(_balance[sender], amount);
        _balance[recipient] = KalancerSafeMath.badd(_balance[recipient], amount);
